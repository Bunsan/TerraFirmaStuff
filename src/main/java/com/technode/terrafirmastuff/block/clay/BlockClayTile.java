...
public class BlockClayTile extends BlockClayDecor {

    public BlockClayTile(Material material)
    {
        super(Material.rock);
    ...
    public void registerBlockIcons(IIconRegister iconRegisterer)
    {
        for(int i = 0; i < names.length; i++)
            icons[i] = iconRegisterer.registerIcon(ModDetails.ModID + ":" + "clay/"+"blockHardenedClayTile"+names[i]);
