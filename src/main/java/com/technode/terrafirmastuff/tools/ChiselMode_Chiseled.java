        ...
        if( hasChisel >= 0 ){
            if(id == ModBlocks.clayStained) {
                if (meta < 8) {
                    //bottom
                    if (side == 0) {
                        world.setBlock(x, y, z, ModBlocks.clayStainedChiseledVert, meta, 0x2);
                    }
                    //top
                    if (side == 1) {
                        world.setBlock(x, y, z, ModBlocks.clayStainedChiseledVert, meta, 0x2);
                    ...
                    //side North
                    if (side == 2) {
                        world.setBlock(x, y, z, ModBlocks.clayStainedChiseledHoriz, meta, 0x2);
                    }
                    //side South
                    if (side == 3) {
                        world.setBlock(x, y, z, ModBlocks.clayStainedChiseledHoriz, meta, 0x2);
                    ...
                    //side West
                    if (side == 4) {
                        world.setBlock(x, y, z, ModBlocks.clayStainedChiseledHoriz, (meta + 8), 0x2);
                    }
                    //side East
                    if (side == 5) {
                        world.setBlock(x, y, z, ModBlocks.clayStainedChiseledHoriz, (meta + 8), 0x2);
                    ...
                    //side North
                    if (side == 2) {
                        world.setBlock(x, y, z, ModBlocks.clayStainedChiseledHoriz2, (meta + 8), 0x2);
                    }
                    //side South
                    if (side == 3) {
                        world.setBlock(x, y, z, ModBlocks.clayStainedChiseledHoriz2, (meta + 8), 0x2);
                    ...
                    //side West
                    if (side == 4) {
                        world.setBlock(x, y, z, ModBlocks.clayStainedChiseledHoriz2, meta, 0x2);
                    }
                    //side East
                    if (side == 5) {
                        world.setBlock(x, y, z, ModBlocks.clayStainedChiseledHoriz2, meta, 0x2);
                ...
                if (meta < 8) {
                    //bottom
                    if (side == 0) {
                        world.setBlock(x, y, z, ModBlocks.clayStainedChiseledVert2, meta, 0x2);
                    }
                    //top
                    if (side == 1) {
                        world.setBlock(x, y, z, ModBlocks.clayStainedChiseledVert2, meta, 0x2);
                    ...
                    //side North
                    if (side == 2) {
                        world.setBlock(x, y, z, ModBlocks.clayStainedChiseledHoriz3, meta, 0x2);
                    }
                    //side South
                    if (side == 3) {
                        world.setBlock(x, y, z, ModBlocks.clayStainedChiseledHoriz3, meta, 0x2);
                    ...
                    //side West
                    if (side == 4) {
                        world.setBlock(x, y, z, ModBlocks.clayStainedChiseledHoriz3, (meta + 8), 0x2);
                    }
                    //side East
                    if (side == 5) {
                        world.setBlock(x, y, z, ModBlocks.clayStainedChiseledHoriz3, (meta + 8), 0x2);
